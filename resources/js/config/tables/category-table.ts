export const CategoryTableConfig = {
    columns: [
        ...
        { label: 'Category Name', key: 'name', className: 'border w-90 p-4' },
    ...
    actions: [
        ...
        { label: 'Delete', icon: 'Trash', route: 'categories.destroy', className: "ms-2 cursor-pointer rounded-lg bg-red-600 p-2 text-white hover:opacity-90" },
    ]
